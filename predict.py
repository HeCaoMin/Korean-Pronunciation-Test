...
parser.add_argument('--resume', default='model/gvlad_softmax/resnet34_vlad8_ghost2_bdim512_deploy/weights.h5', type=str)
#parser.add_argument('--resume', default='../model/gvlad_softmax/2022-05-02_resnet34s_bs64_adam_lr0.001_vlad10_ghost2_bdim512_ohemlevel0/weights-02-0.370.h5', type=str)
parser.add_argument('--batch_size', default=16, type=int)
parser.add_argument('--data_path', default='media/datasets/voxceleb1/wav_database', type=str)
...
def main():
    ...
    if args.test_type == 'normal':
        ...
        # verify_list = np.loadtxt('../meta/4.txt', str)
    ...
    for c, ID in enumerate(unique_list):
        if c % 50 == 0: print('Finish extracting features for {}/{}th wav_database.'.format(c, total_length))
